...
<head>
  ...
  <meta name="description"
    content="About Helping Hands Health Group — our mission, values and commitment to UK healthcare." />
...
<body class="antialiased">
  ...
  <section class="gradient-hero py-20">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
      ...
      <p class="mt-5 text-lg text-slate-600 max-w-3xl mx-auto">Helping Hands Health Group exists to support healthcare
        providers and care professionals across the UK with compassionate, compliant, and dependable staffing.</p>
    </div>
  </section>

  <section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
      <div class="reveal"><img src="https://images.unsplash.com/photo-1581056771107-24ca5f033842?w=900&q=80"
          class="rounded-3xl shadow-soft w-full h-[480px] object-cover" alt="Team" /></div>
      <div class="reveal">
        <h2 class="text-3xl md:text-4xl font-extrabold text-navy">Who We Are</h2>
        <p class="mt-4 text-slate-600 leading-relaxed">We are a UK healthcare recruitment and care support company
          connecting compassionate professionals with trusted care providers — hospitals, care homes, clinics, and
          home-care services nationwide.</p>
        <h3 class="mt-8 text-xl font-bold text-navy">Our Mission</h3>
        <p class="mt-2 text-slate-600">To support healthcare providers and care professionals through reliable,
          compassionate, and compliant healthcare staffing solutions.</p>
        <h3 class="mt-6 text-xl font-bold text-navy">Why We Exist</h3>
        <p class="mt-2 text-slate-600">Because every patient deserves quality care, every employer deserves reliable
          staff, and every healthcare professional deserves a workplace that values them.</p>
      </div>
    </div>
  </section>
