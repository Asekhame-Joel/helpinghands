...
<title>About Us — Helping Hands Health Group</title>
<meta name="description" content="About Helping Hands Health Group — our mission, values and commitment to UK healthcare."/>
...
<a href="about.php" class="nav-link active text-navy text-sm font-semibold">About</a>
...
<section class="gradient-hero py-20">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
    ...
    <h1 class="mt-5 text-4xl md:text-6xl font-extrabold text-navy">Caring for the People Who Care for Others</h1>
    <p class="mt-5 text-lg text-slate-600 max-w-3xl mx-auto">Helping Hands Health Group exists to support healthcare providers and care professionals across the UK with compassionate, compliant, and dependable staffing.</p>
  </div>
</section>

<section class="py-20 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
    <div class="reveal"><img src="https://images.unsplash.com/photo-1581056771107-24ca5f033842?w=900&q=80" class="rounded-3xl shadow-soft w-full h-[480px] object-cover" alt="Team"/></div>
    <div class="reveal">
      <h2 class="text-3xl md:text-4xl font-extrabold text-navy">Who We Are</h2>
      <p class="mt-4 text-slate-600 leading-relaxed">We are a UK healthcare recruitment and care support company connecting compassionate professionals with trusted care providers — hospitals, care homes, clinics, and home-care services nationwide.</p>
      <h3 class="mt-8 text-xl font-bold text-navy">Our Mission</h3>
      <p class="mt-2 text-slate-600">To support healthcare providers and care professionals through reliable, compassionate, and compliant healthcare staffing solutions.</p>
      <h3 class="mt-6 text-xl font-bold text-navy">Why We Exist</h3>
      <p class="mt-2 text-slate-600">Because every patient deserves quality care, every employer deserves reliable staff, and every healthcare professional deserves a workplace that values them.</p>
    </div>
  </div>
</section>
...
<section class="py-24 bg-cloud">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="max-w-3xl mx-auto text-center mb-14 reveal">
      ...
      <h2 class="mt-4 text-3xl md:text-5xl font-extrabold text-navy">The Principles That Guide Every Placement</h2>
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Compassion</h3>
      <p class="text-slate-600 text-sm leading-relaxed">We treat every individual with kindness and dignity.</p>
    </div>
    
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-navy/5 text-navy grid place-items-center mb-5"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
      <h3 class="text-lg font-bold text-navy mb-2">Integrity</h3>
      <p class="text-slate-600 text-sm leading-relaxed">We do what is right — every time, without compromise.</p>
    </div>
    
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-amber-50 text-gold grid place-items-center mb-5"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>
      <h3 class="text-lg font-bold text-navy mb-2">Reliability</h3>
      <p class="text-slate-600 text-sm leading-relaxed">We show up, we follow through, we deliver.</p>
    </div>
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Professionalism</h3>
      <p class="text-slate-600 text-sm leading-relaxed">We hold the highest standards across all our work.</p>
    </div>
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Excellence</h3>
      <p class="text-slate-600 text-sm leading-relaxed">We pursue continuous improvement in every detail.</p>
    </div>
    
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-navy/5 text-navy grid place-items-center mb-5"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="6"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg></div>
      <h3 class="text-lg font-bold text-navy mb-2">Care</h3>
      <p class="text-slate-600 text-sm leading-relaxed">We genuinely care about people and outcomes.</p>
    </div>
