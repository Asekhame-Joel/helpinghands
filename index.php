...
<head>
  ...
  <meta name="description"
    content="Compassionate UK healthcare staffing and care support — Helping Hands Health Group." />
...
<body class="antialiased">
  ...
  <header id="site-header" class="sticky top-0 z-50 bg-white/85 backdrop-blur border-b border-line">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 py-3 flex items-center justify-between">
      ...
      <nav class="hidden lg:flex items-center gap-7"><a href="index.php"
          class="nav-link active text-navy text-sm font-semibold">Home</a>
  ...
  <section class="gradient-hero relative overflow-hidden">
    <div
      class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28 grid lg:grid-cols-12 gap-12 items-center">
      <div class="lg:col-span-7 reveal">
        ...
        <p class="mt-6 text-lg text-slate-600 leading-relaxed max-w-2xl">
          Helping Hands Health Group connects trusted healthcare providers with skilled, compassionate, and compliant
          care professionals — when and where they're needed most.
        </p>
        <div class="mt-8 flex flex-wrap gap-3">
          <a href="employers.php" class="btn-navy px-6 py-3.5 rounded-full font-bold text-sm shadow-soft">Hire
            Healthcare Staff</a>
          <a href="jobs.php" class="btn-primary px-6 py-3.5 rounded-full font-bold text-sm shadow-soft">Find Healthcare
            Jobs</a>
        </div>
        <div class="mt-10 grid sm:grid-cols-2 gap-3 max-w-xl">
          <div class="flex items-center gap-2 text-sm text-slate-700"><span
              class="h-6 w-6 rounded-full bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg></span>UK Healthcare Recruitment</div>
          <div class="flex items-center gap-2 text-sm text-slate-700"><span
              class="h-6 w-6 rounded-full bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg></span>Vetted Care Professionals</div>
          <div class="flex items-center gap-2 text-sm text-slate-700"><span
              class="h-6 w-6 rounded-full bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg></span>Temporary & Permanent Staffing</div>
          <div class="flex items-center gap-2 text-sm text-slate-700"><span
              class="h-6 w-6 rounded-full bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg></span>Compliance-Focused Process</div>
        </div>
      </div>
      <div class="lg:col-span-5 reveal">
        <div class="relative">
          ...
          <div class="relative rounded-[2rem] overflow-hidden shadow-soft border-8 border-white">
            <img src="assets/hero-nurse.jpg" alt="Healthcare team" class="w-full h-[520px] object-cover" />
          </div>
          <div class="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-card flex items-center gap-3 max-w-xs">
            <div class="h-10 w-10 rounded-full bg-emerald-50 text-green-care grid place-items-center"><svg width="22"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
      <div class="reveal">
        <div class="relative rounded-3xl overflow-hidden shadow-soft">
          <img src="assets/team.jpg" alt="Care" class="w-full h-[480px] object-cover" />
        </div>
      </div>
      <div class="reveal">
        <span class="chip">About Helping Hands</span>
        <h2 class="mt-4 text-3xl md:text-4xl font-extrabold text-navy leading-tight">Healthcare Support Built on Trust,
          Compassion, and Reliability</h2>
        <p class="mt-5 text-slate-600 leading-relaxed">Helping Hands Health Group is dedicated to supporting healthcare
          organisations with dependable staffing solutions while helping healthcare professionals find rewarding
          opportunities across the UK.</p>
        <div class="mt-6 grid grid-cols-2 gap-4">
          <div class="flex items-start gap-3"><span
              class="h-9 w-9 rounded-lg bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
                <path
                  d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
            ...
            <div>
              <div class="font-bold text-navy text-sm">Compassion-First</div>
              <div class="text-xs text-slate-500">People at the centre of every placement</div>
            </div>
          </div>
          <div class="flex items-start gap-3"><span
              class="h-9 w-9 rounded-lg bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
            ...
            <div>
              <div class="font-bold text-navy text-sm">Fully Compliant</div>
              <div class="text-xs text-slate-500">DBS, RTW & references checked</div>
            </div>
          </div>
          <div class="flex items-start gap-3"><span
              class="h-9 w-9 rounded-lg bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
            ...
            <div>
              <div class="font-bold text-navy text-sm">Trusted Network</div>
              <div class="text-xs text-slate-500">Healthcare professionals UK-wide</div>
            </div>
          </div>
          <div class="flex items-start gap-3"><span
              class="h-9 w-9 rounded-lg bg-teal-50 text-teal grid place-items-center"><svg width="22" height="22"
            ...
            <div>
              <div class="font-bold text-navy text-sm">Excellence</div>
              <div class="text-xs text-slate-500">Quality you can rely on</div>
            </div>
          </div>
        </div>
        <a href="about.php"
          class="inline-flex items-center gap-2 mt-8 btn-navy px-6 py-3 rounded-full font-bold text-sm">Learn More About
          Us →</a>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-3xl mx-auto text-center mb-14 reveal">
        ...
        <p class="mt-4 text-slate-600 text-lg leading-relaxed">From temporary cover to permanent placements — we provide
          trusted talent for every healthcare setting.</p>
      </div>

      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">

        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5"><svg width="22"
          ...
          <p class="text-slate-600 text-sm leading-relaxed">End-to-end staffing partnership for care providers across
            the UK.</p>
        </div>


        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          <div class="h-12 w-12 rounded-xl bg-navy/5 text-navy grid place-items-center mb-5"><svg width="22" height="22"
              viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              stroke-linejoin="round">
              <path
                d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
          ...
          <p class="text-slate-600 text-sm leading-relaxed">Qualified registered nurses for hospitals, clinics, and care
            settings.</p>
        </div>


        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          <div class="h-12 w-12 rounded-xl bg-amber-50 text-gold grid place-items-center mb-5"><svg width="22"
              height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              stroke-linejoin="round">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
            </svg></div>
          <h3 class="text-lg font-bold text-navy mb-2">Care Assistant Recruitment</h3>
          <p class="text-slate-600 text-sm leading-relaxed">Reliable, trained care assistants for day-to-day care
            delivery.</p>
        </div>


        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          <div class="h-12 w-12 rounded-xl bg-emerald-50 text-green-care grid place-items-center mb-5"><svg width="22"
              height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              stroke-linejoin="round">
              <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
              <circle cx="9" cy="7" r="4" />
          ...
          <p class="text-slate-600 text-sm leading-relaxed">Compassionate support workers for community and residential
            services.</p>
        </div>
        ...
        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          ...
          <p class="text-slate-600 text-sm leading-relaxed">Flexible cover for absences, peak demand and emergencies.
          </p>
        </div>
        ...
        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          ...
          <p class="text-slate-600 text-sm leading-relaxed">Long-term placements aligned with your culture and clinical
            needs.</p>
        </div>
        ...
        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          ...
          <p class="text-slate-600 text-sm leading-relaxed">Trusted home-care professionals supporting independence and
            dignity.</p>
        </div>
        ...
        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          ...
          <p class="text-slate-600 text-sm leading-relaxed">Mandatory training, safeguarding and ongoing CPD support.
          </p>
        </div>
  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-3xl mx-auto text-center mb-14 reveal">
        ...
        <p class="mt-4 text-slate-600 text-lg leading-relaxed">Four clear steps from first contact to placement and
          ongoing support.</p>
      </div>
      ...
      <div class="grid md:grid-cols-4 gap-6">
        ...
        <div class="reveal relative bg-cloud border border-line rounded-2xl p-6 card-hover">
          <div
            class="absolute -top-4 left-6 h-10 w-10 rounded-xl btn-primary grid place-items-center font-extrabold text-navy">
            1</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <a href="jobs.php" class="group card-hover bg-white rounded-2xl p-6 border border-line reveal block">
          <div
            class="h-11 w-11 rounded-xl bg-teal-50 text-teal grid place-items-center mb-4 group-hover:bg-teal group-hover:text-white transition">
  ...
  <section class="py-24 bg-navy text-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto text-center mb-14 reveal">
        <span
          class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-teal-50 text-xs font-bold">Why
          Choose Us</span>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div
          class="reveal bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-7 hover:bg-white/10 transition">
          <div class="h-12 w-12 rounded-xl bg-gold/20 text-gold grid place-items-center mb-4"><svg width="22"
              height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              stroke-linejoin="round">
              <path
                d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-3xl mx-auto text-center mb-14 reveal">
        ...
        <p class="mt-4 text-slate-600 text-lg leading-relaxed">Real words from healthcare leaders and professionals
          we've supported.</p>
      </div>
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="reveal card-hover bg-cloud rounded-2xl p-7 border border-line">
          ...
          <p class="text-slate-700 leading-relaxed italic">"Helping Hands have transformed how we manage staffing. Their
            team is responsive, reliable and the carers they send are always professional."</p>
          <div class="mt-6 flex items-center gap-3 pt-5 border-t border-line">
            <div
              class="h-11 w-11 rounded-full bg-gradient-to-br from-teal to-navy text-white grid place-items-center font-bold">
              S</div>
            <div>
        ...
        <div class="reveal card-hover bg-cloud rounded-2xl p-7 border border-line">
          <div class="flex gap-1 text-gold mb-4">★★★★★</div>
          <p class="text-slate-700 leading-relaxed italic">"I've found stable, flexible work that fits around my family.
            The consultants genuinely listen and support my career goals."</p>
          <div class="mt-6 flex items-center gap-3 pt-5 border-t border-line">
            <div
              class="h-11 w-11 rounded-full bg-gradient-to-br from-teal to-navy text-white grid place-items-center font-bold">
              D</div>
        ...
        <div class="reveal card-hover bg-cloud rounded-2xl p-7 border border-line">
          <div class="flex gap-1 text-gold mb-4">★★★★★</div>
          <p class="text-slate-700 leading-relaxed italic">"Compliance is faultless, communication is excellent, and the
            calibre of nursing staff is exactly what our trust needs."</p>
          <div class="mt-6 flex items-center gap-3 pt-5 border-t border-line">
            <div
              class="h-11 w-11 rounded-full bg-gradient-to-br from-teal to-navy text-white grid place-items-center font-bold">
              A</div>
