  ...
  <meta name="description" content="We support care homes, hospitals, clinics and healthcare organisations with compliant, dependable healthcare professionals."/>
  ...
  <section class="gradient-hero py-20">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
      ...
      <h1 class="mt-5 text-4xl md:text-6xl font-extrabold text-navy">Reliable Healthcare Staffing When You Need It Most</h1>
      <p class="mt-5 text-lg text-slate-600">We support care homes, hospitals, clinics and healthcare organisations with compliant, dependable healthcare professionals.</p>
    </div>
  </section>
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto text-center mb-14 reveal">
        <span class="chip">Employers</span>
        <h2 class="mt-4 text-3xl md:text-5xl font-extrabold text-navy">Reliable Healthcare Staffing When You Need It Most</h2>
        <p class="mt-4 text-slate-600 text-lg leading-relaxed">We support care homes, hospitals, clinics and healthcare organisations with compliant, dependable healthcare professionals.</p>
      </div>
  ...
  <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        ...
        <p class="text-slate-600 text-sm leading-relaxed">Short-term and urgent staffing cover for busy healthcare environments.</p>
      </div>
  <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
        <h3 class="text-lg font-bold text-navy mb-2">Permanent Recruitment</h3>
        <p class="text-slate-600 text-sm leading-relaxed">Find long-term healthcare staff who match your culture and care standards.</p>
      </div>
  <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
        <h3 class="text-lg font-bold text-navy mb-2">Compliance Checks</h3>
        <p class="text-slate-600 text-sm leading-relaxed">DBS, right-to-work, references and role suitability checks.</p>
      </div>
  <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
        <h3 class="text-lg font-bold text-navy mb-2">Fast Response</h3>
        <p class="text-slate-600 text-sm leading-relaxed">Support for urgent staffing gaps and planned recruitment needs.</p>
      </div>
  <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
        <h3 class="text-lg font-bold text-navy mb-2">Vetted Candidates</h3>
        <p class="text-slate-600 text-sm leading-relaxed">Professionals screened for reliability, skill and compassion.</p>
      </div>
  <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
