...
<title>Job Seekers — Helping Hands Health Group</title>
<meta name="description" content="Find flexible shifts, full-time roles, part-time healthcare opportunities and career support across the UK."/>
...
<a href="job-seekers.php" class="nav-link active text-navy text-sm font-semibold">Job Seekers</a>
...
<section class="gradient-hero py-20">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
    <span class="chip">Job Seekers</span>
    <h1 class="mt-5 text-4xl md:text-6xl font-extrabold text-navy">Grow Your Healthcare Career with Helping Hands Health Group</h1>
    <p class="mt-5 text-lg text-slate-600">Find flexible shifts, full-time roles, part-time healthcare opportunities and career support across the UK.</p>
  </div>
</section>
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto text-center mb-14 reveal">
      <span class="chip">Job Seekers</span>
      <h2 class="mt-4 text-3xl md:text-5xl font-extrabold text-navy">Grow Your Healthcare Career with Helping Hands Health Group</h2>
      <p class="mt-4 text-slate-600 text-lg leading-relaxed">Find flexible shifts, full-time roles, part-time healthcare opportunities and career support across the UK.</p>
    </div>
...
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Flexible Roles</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Choose opportunities that fit your schedule and lifestyle.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Career Guidance</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Support with applications, interviews and role matching.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Training Support</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Guidance on required healthcare training and compliance.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Fair Opportunities</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Access to roles in care homes, clinics and home-care settings.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Simple Application</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Submit your details and we will guide you through the process.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Supportive Team</h3>
      <p class="text-slate-600 text-sm leading-relaxed">People-first recruitment support from start to placement.</p>
    </div>
    </div>
