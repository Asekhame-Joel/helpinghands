...
<title>Healthcare Services — Helping Hands Health Group</title>
<meta name="description" content="Comprehensive healthcare staffing & care support services."/>
...
<a href="services.php" class="nav-link active text-navy text-sm font-semibold">Services</a>
...
<section class="gradient-hero py-20">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
    <span class="chip">Healthcare Services</span>
    <h1 class="mt-5 text-4xl md:text-6xl font-extrabold text-navy">End-to-End Healthcare Recruitment & Care Support</h1>
    <p class="mt-5 text-lg text-slate-600">From nursing recruitment to home-care support — explore the breadth of services we offer.</p>
  </div>
</section>
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Healthcare Recruitment</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Permanent and contract recruitment across all UK healthcare settings.</p>
    </div>
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Nursing Support</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Registered nurses, specialist nurses and clinical leads.</p>
    </div>
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Care Assistant Staffing</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Reliable, trained care assistants for daily care delivery.</p>
    </div>
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Support Worker Staffing</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Compassionate support across residential and community services.</p>
    </div>
    
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></div>
      <h3 class="text-lg font-bold text-navy mb-2">Home Care Support</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Domiciliary professionals supporting independence at home.</p>
    </div>
    
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-navy/5 text-navy grid place-items-center mb-5"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div>
      <h3 class="text-lg font-bold text-navy mb-2">Live-in Care Support</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Dedicated live-in carers for 24/7 personal support.</p>
    </div>
    ...
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Training and Compliance</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Mandatory training, safeguarding & CPD programmes.</p>
    </div>
    
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-emerald-50 text-green-care grid place-items-center mb-5"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>
      <h3 class="text-lg font-bold text-navy mb-2">Emergency Cover</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Urgent staffing across the UK, day and night.</p>
    </div>
    
    <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="6"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg></div>
      <h3 class="text-lg font-bold text-navy mb-2">Consultancy</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Strategic workforce planning for healthcare providers.</p>
    </div>
