...
<body class="antialiased">
  ...
  <section class="gradient-hero py-20">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
      ...
      <h1 class="mt-5 text-4xl md:text-6xl font-extrabold text-navy">End-to-End Healthcare Recruitment & Care Support
      </h1>
      <p class="mt-5 text-lg text-slate-600">From nursing recruitment to home-care support — explore the breadth of
        services we offer.</p>
    </div>
  </section>
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5"><svg width="22" height="22"
        ...
        <p class="text-slate-600 text-sm leading-relaxed">Permanent and contract recruitment across all UK healthcare
          settings.</p>
      </div>
      ...
      <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        <div class="h-12 w-12 rounded-xl bg-amber-50 text-gold grid place-items-center mb-5"><svg width="22" height="22"
            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round">
      ...
      <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
        ...
        <p class="text-slate-600 text-sm leading-relaxed">Compassionate support across residential and community
          services.</p>
      </div>
