...
<title>Job Board — Helping Hands Health Group</title>
<meta name="description" content="Browse sample healthcare roles and apply for nursing, care assistant, support worker and live-in care opportunities."/>
...
<a href="jobs.php" class="nav-link active text-navy text-sm font-semibold">Jobs</a>
...
<section class="gradient-hero py-20">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
    <span class="chip">Job Board</span>
    <h1 class="mt-5 text-4xl md:text-6xl font-extrabold text-navy">Find Healthcare Jobs Across the UK</h1>
    <p class="mt-5 text-lg text-slate-600">Browse sample healthcare roles and apply for nursing, care assistant, support worker and live-in care opportunities.</p>
  </div>
</section>
<section class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto text-center mb-14 reveal">
      <span class="chip">Job Board</span>
      <h2 class="mt-4 text-3xl md:text-5xl font-extrabold text-navy">Find Healthcare Jobs Across the UK</h2>
      <p class="mt-4 text-slate-600 text-lg leading-relaxed">Browse sample healthcare roles and apply for nursing, care assistant, support worker and live-in care opportunities.</p>
    </div>
...
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      ...
      <h3 class="text-lg font-bold text-navy mb-2">Healthcare Assistant — Manchester</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Full-time role. Competitive rate. Supporting quality care delivery.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Registered Nurse — Birmingham</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Part-time role. Clinical care support in a trusted care environment.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Support Worker — London</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Temporary shifts supporting individuals with care needs.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Live-in Carer — Leeds</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Full-time live-in care opportunity with ongoing support.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Care Assistant — Liverpool</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Flexible shifts for compassionate care professionals.</p>
    </div>
<div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
      <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
      <h3 class="text-lg font-bold text-navy mb-2">Domiciliary Care Worker — UK-wide</h3>
      <p class="text-slate-600 text-sm leading-relaxed">Community-based care support opportunities.</p>
    </div>
    </div>
