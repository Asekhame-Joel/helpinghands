...
<head>
  ...
  <meta name="description"
    content="Browse sample healthcare roles and apply for nursing, care assistant, support worker and live-in care opportunities." />
...
<body class="antialiased">
  ...
  <section class="gradient-hero py-20">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
      ...
      <p class="mt-5 text-lg text-slate-600">Browse sample healthcare roles and apply for nursing, care assistant,
        support worker and live-in care opportunities.</p>
    </div>
  </section>
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto text-center mb-14 reveal">
        ...
        <p class="mt-4 text-slate-600 text-lg leading-relaxed">Browse sample healthcare roles and apply for nursing,
          care assistant, support worker and live-in care opportunities.</p>
      </div>
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          ...
          <p class="text-slate-600 text-sm leading-relaxed">Full-time role. Competitive rate. Supporting quality care
            delivery.</p>
        </div>
        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
          <h3 class="text-lg font-bold text-navy mb-2">Registered Nurse — Birmingham</h3>
          <p class="text-slate-600 text-sm leading-relaxed">Part-time role. Clinical care support in a trusted care
            environment.</p>
        </div>
        <div class="card-hover bg-white border border-line rounded-2xl p-7 reveal">
          <div class="h-12 w-12 rounded-xl bg-teal-50 text-teal grid place-items-center mb-5">✓</div>
